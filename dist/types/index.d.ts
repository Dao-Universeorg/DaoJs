...
export type InternalDNS = {
    options?: DNSOptions;
    provider?: ethers.providers.Provider;
    signer: JsonRpcSigner;
    graphURI?: string | null;
} & DNS;
export type DNSArgs<K extends keyof InternalDNS> = {
    [P in K]: InternalDNS[P];
};
...
export declare class DNS {
    ...
    /**
     * Creates an object of DNS properties from an array
     * @param {FunctionDeps} dependencies - An array of DNS properties
     * @returns {Object} - An object of DNS properties
     */
    ...
    /**
     * Sets the provider for the DNS class
    ...
    /**
     * Creates a new DNS instance with a different provider, ideally should be used individually with any given function
     * @param {ethers.providers.JsonRpcProvider} provider - The provider to use
     * @returns {DNS} - A new DNS instance with the given provider
     */
    withProvider: (provider: ethers.providers.JsonRpcProvider) => DNS;
    ...
    getAddr: GeneratedRawFunction<{
        raw: ({ contracts, universalWrapper }: DNSArgs<"contracts" | "universalWrapper">, name: string, coinType?: string | number | undefined) => Promise<{
            to: string;
            data: string;
        }>;
        decode: ({ contracts, universalWrapper }: DNSArgs<"contracts" | "universalWrapper">, data: string, _name: string, coinType?: string | number | undefined) => Promise<string | {
            coin: string;
            addr: string;
        } | undefined>;
    }>;
    _getAddr: GeneratedRawFunction<{
        raw: ({ contracts }: DNSArgs<"contracts">, name: string, coinType?: string | number | undefined, bypassFormat?: boolean | undefined) => Promise<{
            to: string;
            data: string;
        }>;
        decode: ({ contracts }: DNSArgs<"contracts">, data: string, _name: string, coinType?: string | number | undefined) => Promise<string | {
            coin: string;
            addr: string;
        } | undefined>;
    }>;
    ...
    getOwner: GeneratedRawFunction<{
        ...
        decode: ({ contracts, multicallWrapper, gqlInstance, }: DNSArgs<"contracts" | "gqlInstance" | "multicallWrapper">, data: string, name: string, contract?: "nameWrapper" | "registrar" | "registry" | undefined) => Promise<{
    ...
    getExpiry: GeneratedRawFunction<{
        raw: (dnsArgs: DNSArgs<"contracts" | "multicallWrapper">, name: string, { contract }?: {
            contract?: ("nameWrapper" | "registrar") | undefined;
        }) => Promise<{
            to: string;
            data: string;
        }>;
        decode: (dnsArgs: DNSArgs<"contracts" | "multicallWrapper">, data: string, name: string, { contract }?: {
            contract?: ("nameWrapper" | "registrar") | undefined;
        }) => Promise<{
            expiry: Date;
            gracePeriod: null;
    ...
    universalWrapper: GeneratedRawFunction<{
        raw: ({ contracts }: DNSArgs<"contracts">, name: string, data: string) => Promise<{
            to: string;
            data: string;
        }>;
        decode: ({ contracts }: DNSArgs<"contracts">, data: string) => Promise<{
    ...
    resolverMulticallWrapper: GeneratedRawFunction<{
        raw: ({ contracts }: DNSArgs<"contracts">, data: {
            to: string;
            data: string;
        }[]) => Promise<{
            to: string;
        ...
        decode: ({ contracts }: DNSArgs<"contracts">, data: string) => Promise<ethers.utils.Result | undefined>;
    }>;
    multicallWrapper: GeneratedRawFunction<{
        raw({ contracts }: DNSArgs<"contracts">, transactions: ethers.providers.TransactionRequest[], requireSuccess?: boolean): Promise<{
            to: string;
            data: string;
        }>;
        decode({ contracts, provider }: DNSArgs<"provider" | "contracts">, data: string, transactions: ethers.providers.TransactionRequest[]): Promise<{
            success: boolean;
            returnData: string;
            0: boolean;
            1: string;
