...
export interface DNSRegistrarInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "claim" | "dns" | "oracle" | "proveAndClaim" | "proveAndClaimWithResolver" | "setOracle" | "setPublicSuffixList" | "suffixes" | "supportsInterface"): FunctionFragment;
...
export interface DNSRegistrar extends BaseContract {
    ...
    functions: {
         ...
         * @param proof A DNS RRSet proving ownership of the name. Must be verified        in the DNSSEC oracle before calling. This RRSET must contain a TXT        record for '_dns.' + name, with the value 'a=0x...'. Ownership of        the name will be transferred to the address specified in the TXT        record.
         */
